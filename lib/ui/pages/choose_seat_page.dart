...
import 'package:airplane_bwa/ui/widget/seat_item.dart';
  ...
  Widget build(BuildContext context) {
                  ...
                  children: [
                    ...
                    Text(
                      NumberFormat.currency(
                          ...
                          .format(state.length * (destination?.price ?? 0)),
    ...
    Widget checkoutButton() {
      return BlocBuilder<SeatCubit, List<String>>(
        builder: (context, state) {
          return CustomButton(
            title: "Continue to Checlout",
            onPressed: () {
              int price = (destination?.price ?? 0) * state.length;
